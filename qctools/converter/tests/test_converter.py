...
def test_conversion_inverse(example_converter, random_value):
    ...
    assert round(fac/random_value, 8) == round(example_converter.convert(random_value, 'ref', 'cm'), 8)
...
def test_conversion_direct(example_converter, random_value):
    ...
    assert round(fac*random_value, 8) == round(example_converter.convert(
                                                   random_value, 'ref', 'eV'), 8)
